defmodule PhoenixFintechWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: PhoenixFintechWeb.Gettext
  ...
  attr :class, :any
  attr :variant, :string, values: ~w(primary secondary neutral ghost soft error)
  ...
  def button(%{rest: rest} = assigns) do
    ...
    assigns =
      assign(assigns, :class, assigns[:class] || ["btn", Map.fetch!(variants, assigns[:variant])])
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhoenixFintechWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhoenixFintechWeb.Gettext, "errors", msg, opts)
    end
  end
