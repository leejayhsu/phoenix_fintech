defmodule PhoenixFintech.Ledger.JournalEntry do
  ...
  schema "ledger_journal_entries" do
    field :source_type, Ecto.Enum, values: [:transfer, :manual_adjustment, :fee, :provider_settlement, :reversal]
  ...
  defp validate_source_pair(changeset) do
    ...
    if is_nil(source_type) == is_nil(source_id), do: changeset, else: add_error(changeset, :source_type, "must be paired with source_id")
  end
end
