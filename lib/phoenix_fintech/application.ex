defmodule PhoenixFintech.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: PhoenixFintech.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    PhoenixFintechWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
