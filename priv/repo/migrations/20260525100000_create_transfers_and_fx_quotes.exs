defmodule PhoenixFintech.Repo.Migrations.CreateTransfersAndFxQuotes do
  ...
  def change do
    ...
    create constraint(:transfers, :transfers_distinct_parties_check,
             check: "originator_party_id <> counterparty_party_id"
           )

    create constraint(:transfers, :transfers_originator_amount_gt_zero,
             check: "amount_in_originator_currency > 0"
           )

    create constraint(:transfers, :transfers_counterparty_amount_gt_zero,
             check: "amount_in_counterparty_currency > 0"
           )
  end
end
